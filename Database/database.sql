...
/****** Object:  Database [garden]    Script Date: 7/20/2013 10:14:05 AM ******/
...
CREATE DATABASE [garden]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'garden', FILENAME = N'c:\Program Files\Microsoft SQL Server\MSSQL11.SQLEXPRESS\MSSQL\DATA\garden.mdf' , SIZE = 3072KB , MAXSIZE = UNLIMITED, FILEGROWTH = 1024KB )
 LOG ON 
( NAME = N'garden_log', FILENAME = N'c:\Program Files\Microsoft SQL Server\MSSQL11.SQLEXPRESS\MSSQL\DATA\garden_log.ldf' , SIZE = 1024KB , MAXSIZE = 2048GB , FILEGROWTH = 10%)
GO

ALTER DATABASE [garden] SET COMPATIBILITY_LEVEL = 110
GO
...
ALTER DATABASE [garden] SET AUTO_CLOSE OFF 
GO
...
ALTER DATABASE [garden] SET  DISABLE_BROKER 
GO
...
ALTER DATABASE [garden] SET TARGET_RECOVERY_TIME = 0 SECONDS 
GO
